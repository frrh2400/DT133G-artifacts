...
# Load results
# Update file path
df <- read.csv("/summary_evaluation.csv")
...
# Generate QQ-plot for ROUGE-L
# Update file path
res <- residuals(rouge$aov$lm)
...
res <- residuals(rouge_log_without_outliers$aov$lm)

png(
  "/rouge_log_without_outliers_qqplot.png",
  width = 700,
  height = 700
)
...
qqnorm(
  res,
  main = "QQ-plot of ROUGE-L F1 log without outliers"
)
...
# Generate QQ-plot for BERTScore
# Update file path
res <- residuals(bert$aov$lm)
...
res <- residuals(bert_log_without_outliers$aov$lm)

png(
  "/bert_log_without_outliers_qqplot.png",
  width = 700,
  height = 700
)
...
qqnorm(
  res,
  main = "QQ-plot of BERTScore F1 log without outliers"
)
...
# Generate QQ-plots for prompt tokens
# Update file path
res <- residuals(prompt_tokens$aov$lm)

png(
  "/prompt_tokens_qqplot.png",
  width = 700,
  height = 700
)
...
res <- residuals(prompt_tokens_log_without_outliers$aov$lm)

png(
  "/prompt_tokens_log_without_outliers_qqplot.png",
  width = 700,
  height = 700
)
...
qqnorm(
  res,
  main = "QQ-plot of prompt tokens log without outliers"
)
...
# Generate QQ-plots for summary tokens
# Update file path
res <- residuals(summary_tokens$aov$lm)

png(
  "/summary_tokens_qqplot.png",
  width = 700,
  height = 700
)
...
qqnorm(
  res,
  main = "QQ-plot of summary tokens"
)
...
res <- residuals(summary_tokens_log_without_outliers$aov$lm)

png(
  "/summary_tokens_log_without_outliers_qqplot.png",
  width = 700,
  height = 700
)
...
qqnorm(
  res,
  main = "QQ-plot of summary tokens log without outliers"
)
...
# Generate QQ-plots for total tokens
# Update file path
res <- residuals(total_tokens$aov$lm)

png(
  "/total_tokens_qqplot.png",
  width = 700,
  height = 700
)
...
res <- residuals(total_tokens_log_without_outliers$aov$lm)

png(
  "/total_tokens_log_without_outliers_qqplot.png",
  width = 700,
  height = 700
)
...
qqnorm(
  res,
  main = "QQ-plot of total tokens log without outliers"
)
...
# Generate EMM plot for prompt token usage
p <- emmip(
  prompt_tokens_without_outliers$emm,
  example ~ instruction | context,
  CIs = TRUE,
  xlab = "Instruction",
  ylab = "Estimated prompt token usage"
)

# Save plot
# Update file path
ggsave(
  "/prompt_token_emmip.png",
  plot = p,
  width = 7,
  height = 7
)

# Generate EMM plot for summary token usage
p <- emmip(
  summary_tokens_without_outliers$emm,
  example ~ instruction | context,
  CIs = TRUE,
  xlab = "Instruction",
  ylab = "Estimated summary token usage"
)

# Save plot
# Update file path
ggsave(
  "/summary_token_emmip.png",
  plot = p,
  width = 7,
  height = 7
)
